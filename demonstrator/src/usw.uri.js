...
Project : Any
Classes : usw.uri.RDF, usw.uri.RDFS, usw.uri.SKOS etc.
Summary : Reusable constants defining case-sensitive entity and property URIs 
...
// define top-level base namespace
var usw = (this.usw || {});  
usw.uri = (usw.uri || {});
...
// either call returns "http://purl.org/crmeh#EHE0001_EHrecord"    
usw.uri.CRMEH = { NS: "http://purl.org/crmeh#" };
usw.uri.CRMEH = {
    NS: usw.uri.CRMEH.NS, // else it is overwritten
    // entities
    EHE0001: usw.uri.CRMEH.NS + "EHE0001_EHrecord",
    ...
    EHE0021: usw.uri.CRMEH.NS + "EHE0021_EHrecordTimespan",
    ...
    EHE0076: usw.uri.CRMEH.NS + "EHE0076_recordDesign",
    EHE0077: usw.uri.CRMEH.NS + "EHE0077_recordTeamMember",
    EHE0078: usw.uri.CRMEH.NS + "EHE0078_recordTeamMemberRole",
...
usw.uri.CRM = {
    ...
    P82a: usw.uri.CRM.NS + "P82a_begin_of_the_begin",
    P82b: usw.uri.CRM.NS + "P82b_end_of_the_end",
...
// usw.uri.TRIDAS - dendrochronology data. Not all elements and properties 
// are present here, just ones used in ARIADNE dendro work, add more later
// usage: alert(usw.uri.TRIDAS.record) | alert(usw.uri.TRIDAS["record"])
// either call returns "http://www.tridas.org/1.2.2/record"
usw.uri.TRIDAS = { NS: "http://www.tridas.org/1.2.2/" };
usw.uri.TRIDAS = {
    NS: usw.uri.TRIDAS.NS, // else it is overwritten
    record: usw.uri.TRIDAS.NS + "record",
    OBJECT: usw.uri.TRIDAS.NS + "object",
    ELEMENT: usw.uri.TRIDAS.NS + "element",
    SAMPLE: usw.uri.TRIDAS.NS + "sample"
};

// usw.uri.GVP - Getty Vocabulary Program. Not all elements and properties 
// are present here, just ones used in ARIADNE dendro work, add more later
// usage: alert(usw.uri.GVP.BROADERGENERIC) | alert(usw.uri.GVP["BROADERGENERIC"])
// either call returns "http://vocab.getty.edu/ontology#broaderGeneric"
usw.uri.GVP = { NS: "http://vocab.getty.edu/ontology#" };
usw.uri.GVP = {
    NS: usw.uri.GVP.NS, // else it is overwritten
    BROADERGENERIC: usw.uri.GVP.NS + "broaderGeneric",
    BROADERPREFERRED: usw.uri.GVP.NS + "broaderPreferred",
    DISPLAYORDER: usw.uri.GVP.NS + "displayOrder",
    PARENTSTRING: usw.uri.GVP.NS + "parentString",
    PARENTSTRINGABBREV: usw.uri.GVP.NS + "parentStringAbbrev",
    PREFLABELGVP: usw.uri.GVP.NS + "prefLabelGVP",
    PREFLABELLOC: usw.uri.GVP.NS + "prefLabelLoC",
    TERM: usw.uri.GVP.NS + "term"
};

usw.uri.AAT = { NS: "http://vocab.getty.edu/aat/" };
usw.uri.TGN = { NS: "http://vocab.getty.edu/tgn/" };
usw.uri.ULAN = { NS: "http://vocab.getty.edu/ulan/" };
...
usw.uri.FOAF = {
    ...
    CURRENTrecord: usw.uri.FOAF.NS + "currentrecord",
    ...
    PASTrecord: usw.uri.FOAF.NS + "pastrecord",
